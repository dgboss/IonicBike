		...
		function createNewSlider(element, options) {
			...
			**************************************************/
			...
			if (this.sliderElem) {
				...
				this.sliderElem.className = "bma-slider";

				/* Create slider track elements */
				var sliderTrack = document.createElement("div");
				sliderTrack.className = " bma-slider slider-track";

				sliderTrackLow = document.createElement("div");
				sliderTrackLow.className = "bma-slider slider-track-low";

				sliderTrackSelection = document.createElement("div");
				sliderTrackSelection.className = "bma-slider slider-selection";

				sliderTrackHigh = document.createElement("div");
				sliderTrackHigh.className = "bma-slider slider-track-high";

				sliderMinHandle = document.createElement("div");
				sliderMinHandle.className = "bma-slider slider-handle min-slider-handle";

				sliderMaxHandle = document.createElement("div");
				sliderMaxHandle.className = "bma-slider slider-handle max-slider-handle";
				...
				if (Array.isArray(this.options.ticks) && this.options.ticks.length > 0) {
					for (i = 0; i < this.options.ticks.length; i++) {
						...
						tick.className = 'bma-slider    slider-tick';
